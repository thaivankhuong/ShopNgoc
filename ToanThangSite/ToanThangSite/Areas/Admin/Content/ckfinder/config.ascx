...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        BaseUrl = "~/Areas/Admin/Content/Fileuploads/";

        // The phisical directory in the server where the file will end up. If
        // blank, CKFinder attempts to resolve BaseUrl.
        BaseDir = HttpContext.Current.Server.MapPath("~/Areas/Admin/Content/Fileuploads/");
        ...
        Thumbnails.MaxWidth = 540;
        Thumbnails.MaxHeight = 260;
