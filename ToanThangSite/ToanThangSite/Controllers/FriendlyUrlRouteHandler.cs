        ...
        protected override IHttpHandler GetHttpHandler(System.Web.Routing.RequestContext requestContext)
        {
            ...
            if(friendlyUrl!=null&& friendlyUrl != string.Empty)
            {
                ...
                if (friendlyUrl.Contains("pg"))
                {
                    ...
                    foreach (var item in db.ProductCategories.Where(x => x.Status == true && x.SeoUrl != "the-gioi-tra.html" && x.SeoUrl != "thao-duoc.html" && x.SeoUrl != "mat-ong.html" && x.SeoUrl != "dac-san-vung-mien.html"))
                    {
                        if (item.SeoUrl == friendlyUrl)
                        {
                            requestContext.RouteData.Values["controller"] = "Product";
