...
jQuery(document).ready(function () {
    ...
    var sel1 = jQuery('#dualselect select');		//get first select element
    var sel2 = jQuery('#dualselect #BranchList');			//get second select element
        ...
        if (t) {
            sel1.find('option').each(function () {
                if (jQuery(this).is(':selected')) {
                    ...
                    if (sel2.val().includes(";" + jQuery(this).val()) == false) {
                        sel2.val(sel2.val() + ";" + jQuery(this).val());
                    }
            ...
            sel1.find('option').each(function () {
                if (jQuery(this).is(':selected')) {
                    jQuery(this).attr('selected', false);
                    sel2.val(sel2.val().replace(";" + jQuery(this).val(),""));
                }
            });
        }
        return false;
